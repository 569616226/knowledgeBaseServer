...
class GetAllAdminsTest extends TestCase
{
    ...
    public function testGetAllAdmins_()
    {
        ...
        $admin_counts = User::where('is_client',false)->get()->count();


        // assert the returned data size is correct
        $this->assertCount($admin_counts, $responseContent->data); // 2 (fake in this test) + 1 (that is logged in) + 1 (seeded super admin)
    }
