...
use App\Containers\User\UI\API\Requests\FrozenAdminRequest;
...
class Controller extends ApiController
{
    ...
    public function registerUser(RegisterUserRequest $request)
    {
        ...
        return $this->created($this->transform($user, UserTransformer::class), 200);
    }
     ...
     * @return  mixed
     */
    public function frozenAdmin(FrozenAdminRequest $request)
    {
        $admin = Apiato::call('User@FrozenAdminAction', [$request]);
