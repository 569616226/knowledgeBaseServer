...
use App\Containers\Authorization\UI\API\Requests\SyncRoleMenusRequest;
...
class Controller extends ApiController
{
    ...
    /**
     * @param SyncRoleMenusRequest $request
     * @return array
     */
    public function syncRoleMenus(SyncRoleMenusRequest $request)
    {
        $role = Apiato::call('Authorization@SyncRoleMenusAction', [$request]);
